...
export const api = {
  ...
  lots: (product_id, warehouse_id, sale_id) => get('/api/stock/lots', { product_id, warehouse_id, sale_id }),
  ...
  cancel: (id, rehome = false) => post(`/api/deals/${id}/cancel${rehome ? '?rehome=true' : ''}`),
  cancelPreview: id => get(`/api/deals/${id}/cancel/preview`),
  editDeal: (id, body) => post(`/api/deals/${id}/edit`, body),
  editPreview: (id, body) => post(`/api/deals/${id}/edit/preview`, body),
